...
//    private int[][] allChess=new int[19][19];
    private int [][]allChess=new int[25][25];
    //当前棋子的总数
    private int chessSum=0;
...
// 基础 方法
class WUZIFrame extends JFrame implements MouseListener{
...
//    private int[][] allChess=new int[19][19];
    ...
    // 按键
    private JButton withdraw=new JButton("悔棋");
