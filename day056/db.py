...
def SQLAlchemy_demo():
	...
	# 创建引擎
	engine = create_engine("mysql+pymysql://admin:admin@127.0.0.1:3306/mysql", max_overflow=5)
	# 执行sql语句
...
engine = create_engine("mysql+pymysql://admin:admin@127.0.0.1:3306/mysql", max_overflow=5,encoding='utf-8')
